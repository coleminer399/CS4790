...
namespace FoodDelivery.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<FoodDeliveryUser> _signInManager;
        ...
        public RegisterModel(
            ...
            SignInManager<FoodDeliveryUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new FoodDeliveryUser { UserName = Input.Email, Email = Input.Email };
